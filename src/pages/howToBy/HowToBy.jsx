    ...
    <div>
      <div className="home max-w-[1300px] md:mx-auto  sm:mx-[12px] ">
        <div className="container max-w-[1100px] mx-auto p-[30px] ">
          <div className="text-[#FFFFFF]">
            ...
            <h2 className=" md:text-[26px] font-bold	leading-[34px] not-italic	sm:text-[20px] mt-[20px]">
              Научим покупать вВеликобритании!
            </h2>
            <p className="mt-[15px]">и экономить до 70%</p>
          </div>
          <div className="mt-[30px] mb-[40px] ">
            <Btn name={t("how.btn1")}></Btn>
          </div>
        </div>
      </div>
      ...
      <div className="section4 py-[90px]">
        <div className="container max-w-[1100px] mx-auto  sm:px-[20px]">
          <div className=" md:w-[68%] sm:w-full">
          ...
          <div className="number py-[40px] sm:flex sm:flex-col md:flex md:flex-row gap-[30px] items-center ">
            <div>
              <img src={fn1} alt="" />
            </div>
            <div className=" w-[80%]">
              <div className="flex gap-[20px] md:w-[56%] sm:w-full items-center">
                <span>01</span>
          ...
          <div className="number py-[40px] sm:flex sm:flex-col md:flex md:flex-row gap-[30px] items-center ">
            ...
            <div className=" w-[80%]">
              ...
              <div>
                <p>
                  Выбираем нужные товары в магазинах Англии. Расплачиваемся, как
                  обычно, в качестве адреса доставки указываем координаты одного
                  из складов Okeypost. Оформить покупки можно самостоятельно или
                  с нашей помощью. Вот список того, что покупать нельзя.
                </p>
              </div>
            </div>
          </div>
          <div className="number py-[40px] sm:flex sm:flex-col md:flex md:flex-row gap-[30px] items-center ">
            ...
            <div className=" w-[80%]">
              ...
              <div>
                <p>
                  После оформление заказа магазин пришлет трек-номер посылки на
                  ваш e-mail и отправит вещи на наш склад. Через 5-7 дней
                  покупки придут к нам, мы поместим их в специальное хранилище,
                  закрепленное за вашим аккаунтом.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="number py-[40px] sm:flex sm:flex-col md:flex md:flex-row gap-[30px] items-center ">
            ...
            <div className=" w-[80%] ">
              ...
              <div>
                <p>
                  Примерно через 2 недели посылка приедет к вам домой, в пункт
                  выдачи заказов или на почту. Получаем покупки и радуемся :)
                </p>
              </div>
            </div>
          </div>
