...
const Help = () => {
  ...
  return (
    <div>
      <div className=" bg_blue   dark:bg-[#5B52A3] shadow-2xl w-[95%] m-auto rounded-[50px] mt-[20px] py-[50px] mb-[50px]">
        <div className="w-[90%] m-auto">
          <p className="text-white">{t("section13.text")}</p>
          <h1 className="text-white sm:text-[30px] md:text-[40px] font-[800]">
            {t("section13.text1")}
          </h1>
        </div>
      </div>
      <div className="bg-[#FFF] dark:bg-[#5B52A3] shadow-2xl w-[90%] m-auto rounded-[10px] my-[20px] p-[20px]">
        <div className="p-[7px] border-b-2">
          <p className="dark:text-white">{t("section13.text2")}</p>
          <p className="dark:text-white mt-[12px]">{t("section13.text3")}</p>
        </div>
      </div>
      <div className="w-[90%] m-auto my-[50px]">
        <h1 className="dark:text-white sm:text-[25px] md:text-[35px] font-[800] text-[#1F2428]">
          {t("section13.text5")}
        </h1>
      </div>
      <div className="w-[90%] m-auto mt-[50px] ">
        <Accordion className="mb-[10px] dark:bg-[#5B52A3] ">
          <AccordionSummary
            expandIcon={<ExpandMoreIcon className="dark:text-white" />}
            aria-controls="panel1a-content"
            id="panel1a-header"
          >
            <Typography className="font-[800] dark:text-white">
              {t("section13.text6")}
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography className="dark:text-white">
              ...
              consectetur porro nostrum neque nisi delectus corrupti iure
              aspernatur. Dignissimos consectetur eos eius suscipit praesentium
              sequi error perspiciatis, itaque saepe nihil.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion className="mb-[10px] dark:bg-[#5B52A3] ">
      ...
      <div className="bg_blue max-w-[1300px] md:mx-auto  sm:mx-[12px]  mt-[40px]">
