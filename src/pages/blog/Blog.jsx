    ...
    <div>
      ...
      <div className="section4 py-[90px]">
        <div className="container max-w-[1100px] mx-auto  sm:px-[20px]">
          <div className="bonusgrid grid lg:grid-cols-3 gap-6 sm:grid-cols-1 md:grid-cols-2">
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im1} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Интернет-магазин Urban Outfitters в UK: обзор</h2>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im2} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Overstock. Брендовые товары по доступным ценам</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im3} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Skechers с Amazon. Удобная обувь для всей семьи</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im4} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>16 лучших подарков с Амазона в 2021 году</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im5} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Overstock. Брендовые товары по доступным ценам</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im6} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Skechers с Amazon. Удобная обувь для всей семьи</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im7} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Nautica. Элитные товары из Англии по низким ценам</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im8} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Forever 21 - покупаем джинсы за 1 500 рублей</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im9} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Как купить кроссовки Balenciaga на 30 000 рублей?</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im10} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>Топ-7 самых дорогих сумок Louis Vuitton</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im11} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>BH Cosmetics Galaxy. Галактика красоты и ухода </h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
            ...
            <div className="bg-[#FFF] drop-shadow-lg  rounded-[16px]">
              <img src={im12} alt="" className="rounded-t-[16px]" />
              <div className="p-[26px_25px]">
                <h2>“Вансы”. Крутые кеды, которые не выйдут из моды!</h2>
                <div className="flex justify-between mt-[20px]">
                  <p>22.10.2021</p>
                  <span>Читать: 8 минут</span>
                </div>
